...
FROM ( 
	...
	SELECT TM_KEY_DAY, 'B7R000102' AS METRIC_CD, 'Prepaid ARPU' AS METRIC_NAME
		...
		, SUM(CASE WHEN METRIC_CD = 'B1R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'B1S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'B7R000101' AS METRIC_CD, 'Postpaid ARPU' AS METRIC_NAME
		, 'ALL' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'B2R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'B2S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'B7R010101' AS METRIC_CD, 'Postpaid ARPU B2C' AS METRIC_NAME
		, 'ALL' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'B2R010100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'B2S010500' THEN ACTUAL_AGG END) DENOMINATOR
		, '"B2R010100 Postpaid Revenue B2C" / "B2S010500 Postpaid Active Subs B2C"' AS REMARK
	FROM GEOSPCAPPO.AGG_PERF_NEWCO 
	WHERE METRIC_CD IN ('B2R010100', 'B2S010500')
	AND TM_KEY_YR >= (SELECT TM_KEY_YR FROM W_PARAM)
	AND AREA_TYPE <> 'C' -->> B2C Only
	GROUP BY TM_KEY_DAY, AREA_TYPE, AREA_CD, AREA_NAME
	...
	SELECT TM_KEY_DAY, 'DB7R000102' AS METRIC_CD, 'Prepaid ARPU : DTAC' AS METRIC_NAME
		...
		, SUM(CASE WHEN METRIC_CD = 'DB1R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'DB1S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'DB7R000101' AS METRIC_CD, 'Postpaid ARPU : DTAC' AS METRIC_NAME
		, 'DTAC' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'DB2R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'DB2S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'DB7R010101' AS METRIC_CD, 'Postpaid ARPU B2C : DTAC' AS METRIC_NAME
		, 'DTAC' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'DB2R010100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'DB2S010500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'TB7R000102' AS METRIC_CD, 'Prepaid ARPU : TMH' AS METRIC_NAME
		...
		, SUM(CASE WHEN METRIC_CD = 'TB1R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'TB1S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'TB7R000101' AS METRIC_CD, 'Postpaid ARPU : TMH' AS METRIC_NAME
		, 'TRUE' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'TB2R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'TB2S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'TB7R010101' AS METRIC_CD, 'Postpaid ARPU B2C : TMH' AS METRIC_NAME
		, 'TRUE' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'TB2R010100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'TB2S010500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'TB7R000103' AS METRIC_CD, 'TOL ARPU' AS METRIC_NAME
		, 'TRUE' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'TB3R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'TB3S000500' THEN ACTUAL_AGG END) DENOMINATOR
	...
	SELECT TM_KEY_DAY, 'TB7R000104' AS METRIC_CD, 'TVS ARPU' AS METRIC_NAME
		, 'TRUE' AS COMP_CD, 'A' AS VERSION, AREA_TYPE, AREA_CD, AREA_NAME
		, SUM(CASE WHEN METRIC_CD = 'TB4R000100' THEN ACTUAL_AGG END) NUMERATOR
		, SUM(CASE WHEN METRIC_CD = 'TB4S000500' THEN ACTUAL_AGG END) DENOMINATOR
