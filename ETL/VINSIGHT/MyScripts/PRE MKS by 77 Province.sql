...
/*** Rawdata : Prepaid MKS by 77 Province ***/
...
(
	SELECT SUBSTR(TM_KEY_DAY,1,4) AS TM_KEY_YR, SUBSTR(TM_KEY_DAY,1,6) AS TM_KEY_MTH, PRODUCT_GRP AS PRODUCT
		...
		, SUM(CASE WHEN METRIC_CD = 'VIN00059' THEN ACTUAL_AGG_MTH END) AS "SUBS_TMH & DTAC"
		, SUM(CASE WHEN METRIC_CD = 'VIN00060' THEN ACTUAL_AGG_MTH END) AS SUBS_AIS
		, SUM(CASE WHEN METRIC_CD = 'VIN00061' THEN ACTUAL_AGG_MTH END) AS SUBS_TMH
		, SUM(CASE WHEN METRIC_CD = 'VIN00062' THEN ACTUAL_AGG_MTH END) AS SUBS_DTAC
		, SUM(CASE WHEN METRIC_CD IN ('VIN00060', 'VIN00061', 'VIN00062') THEN ACTUAL_AGG_MTH END) SUBS_TOTAL
