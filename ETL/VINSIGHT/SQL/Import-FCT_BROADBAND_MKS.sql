...
(
	...
	WHERE TM_KEY_MTH > (SELECT V_ACTUAL_MONTH_END FROM W_PARAM)
...
(
	...
	FROM (
		...
		-- WHERE A.TM_KEY_MTH = (SELECT V_ACTUAL_MONTH_END FROM W_PARAM)
...
FROM (
	...
	SELECT P.TM_KEY_YR, P.TM_KEY_MTH, P.TRUE_TM_KEY_WK, P.TM_KEY_DAY
		...
		, 'Data as of : '||(SELECT V_ACTUAL_MONTH_END FROM W_PARAM) AS REMARK
	FROM W_RAW_BROADBAND_MKS_MONTHLY A
