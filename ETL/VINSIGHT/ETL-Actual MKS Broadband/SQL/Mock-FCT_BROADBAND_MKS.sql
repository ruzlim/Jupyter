...
(
	SELECT TM_KEY_MTH, METRIC_CD, METRIC_NAME, COMP_CD, VERSION, AREA_NO, AREA_TYPE, AREA_CD, AREA_NAME, METRIC_VALUE, AGG_TYPE, FREQUENCY
...
SELECT P.TM_KEY_YR, P.TM_KEY_MTH, P.TRUE_TM_KEY_WK, P.TM_KEY_DAY
	, METRIC_CD, METRIC_NAME, COMP_CD, VERSION, AREA_NO, AREA_TYPE, AREA_CD, AREA_NAME, METRIC_VALUE, AGG_TYPE, FREQUENCY
	, 'Data as of : '||(SELECT V_MTH_END_FCT FROM W_PARAM) AS REMARK
...
-->> Test
-- AND METRIC_CD = 'VIN00020' AND AREA_CD = 'P'